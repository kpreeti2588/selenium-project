...
public class LoginTestCase extends Init{
	...
	CreateAccount ca =null;
		...
		@Test(dataProvider="getSignInData")
		public void verifyLogoff(Hashtable<String,String> data) throws InterruptedException, IOException {
			si.enterEmailforSignIn(data.get("Email"));
			si.enterPasswordforSignIn(data.get("Password"));
			si.clickSignIn();
			Thread.sleep(1000);
			...
			Assert.assertEquals(driver.getCurrentUrl(), PropertyReader.getProperty("authenticURL"),"Redirected to correct URL");
